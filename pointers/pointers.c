...
// ** NOTES **
// the asterisk (*) symbol; indirection operator, is used to declare and manipulate (dereference) pointers - a pointer is a variable that holds memory addresses of different variables of similar data types - * can be used to dereference a pointer to return the original value
